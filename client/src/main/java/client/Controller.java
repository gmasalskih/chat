...
public class Controller implements Initializable {
    ...
    private final HistoryHandler historyHandler = LocalhostHistoryHandler.getInstance();
...
/////////////////
 ...
 ////////////////
                    ...
                    textArea.appendText(historyHandler.getLastHundredMsg(nickname));
                    // цикл работы
                    while (true) {
                        String str = in.readUTF();
                        historyHandler.writeLastMsg(str, nickname);
                        if (str.startsWith("/")) {
                            if (str.equals("/end")) {
                                setAuthenticated(false);
                                break;
    ...
    public void sendMSG() {
//        historyHandler.writeLastMsg(textField.getText(), nickname);
        try {
